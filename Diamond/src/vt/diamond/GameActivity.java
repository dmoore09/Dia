    ...
    extends FragmentActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        try
        {
            questionsf = createQuestionBankLevel(pref);
        }
        catch (IOException e)
        {
    ...
    /**
     * creates a question bank based on hotness level, uses creaste question bank
     * @param level user specifications
     * @return question bank
     * @throws IOException
     */
    public Question[] createQuestionBankLevel(boolean level[]) throws IOException{
        //TODO create new banks for each hotness level
        //low
        if (level[4]) {
            return createQuestionBank(level, "questions/wyr.txt", "questions/questionsBeta.txt", 30, 98);
        }
        //medium
        else if (level[5]) {
            return createQuestionBank(level, "questions/wyr.txt", "questions/questionsBeta.txt", 30, 98);
        ...
        //high
            ...
            return createQuestionBank(level, "questions/wyrHot.txt","questions/sexHot.txt", 21, 65);
        }
    }
     ...
     * @throws IOException
     */
    public Question[] createQuestionBank(boolean[] pref, String wyrLvl, String sexLvl, int wyrAmount, int sexAmount) throws IOException {
